...
class HelloTriangleApp 
{
	...
	private:
        ...
        void pickPhysicalDevice()
        {
            ...
            if (deviceCount == 0) {
                throw new std::runtime_error("No GPUs found with Vulkan support");
            }
        ...
        void createSurface()
        {
            if(glfwCreateWindowSurface(instance, window, nullptr, &surface) != VK_SUCCESS) {
                throw new std::runtime_error("could not create window surface");
            }
        }
        ...
        void createGraphicsPipeline()
        {
            ...
            VkViewport viewport{}; //region of the framebuffer the output's rendered to. define transformation from image to framebuffer
            viewport.x = 0.0f;
            viewport.y = 0.0f;
            ...
            VkRect2D scissor{}; // rectangle that pixels show up in. rasterizer cuts off anything outside this rectangle.
            scissor.offset = {0, 0};
            ...
            VkPipelineRasterizationStateCreateInfo rasterizer{}; //Takes geometry shaped by vertices and turns it into fragments
            ...
            VkPipelineMultisampleStateCreateInfo multisampling{}; //a way to performa anti-aliasing
            ...
            VkPipelineColorBlendAttachmentState colorBlendAttachment{}; //color blending
            colorBlendAttachment.colorWriteMask = VK_COLOR_COMPONENT_R_BIT | VK_COLOR_COMPONENT_G_BIT | VK_COLOR_COMPONENT_B_BIT | VK_COLOR_COMPONENT_A_BIT;
            colorBlendAttachment.blendEnable = VK_FALSE; //when false, color is same as color from fragment shader. else it's blended with a previous color
